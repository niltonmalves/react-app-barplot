...
class ApexChart extends React.Component {   
    ...
    refreshList = () => {
      axios
        ...
        .then(res => {
           const {CleanTextProcessorSeg, FilterProcessedFilesSeg,ImageConverterProcessorSeg, NonTextBlockFilterSeg, ObjectDetectionProcessorSeg,TextExtractionProcessorSeg } = res.data
