...
class ApexChart extends React.Component {   
    ...
    refreshList = () => {
      axios
        ...
        .then(res => {
           let {CleanTextProcessorSeg, FilterProcessedFilesSeg,ImageConverterProcessorSeg, NonTextBlockFilterSeg, ObjectDetectionProcessorSeg,TextExtractionProcessorSeg } = res.data
